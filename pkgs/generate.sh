...
pushd "${scriptDir}"
  ...
  runInShell "cabal2nix glibcLocales" $(nix-build -A stack2nix --no-out-link -Q ../)/bin/stack2nix --platform x86_64-linux --hackage-snapshot 2018-04-22T11:56:04Z -j8 --test ./.. > default.nix.new
